...
class _FirstPageWidgetState extends State<FirstPageWidget> {
  ...
  void initState() {
    ...
    _model.polidromTextController ??= TextEditingController();
    _model.polidromFocusNode ??= FocusNode();
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        controller: _model.polidromTextController,
                        focusNode: _model.polidromFocusNode,
                        autofocus: true,
                        obscureText: false,
                        decoration: InputDecoration(
                          labelStyle:
                        ...
                        validator: _model.polidromTextControllerValidator
                            .asValidator(context),
                      ),
                    ),
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(8.0, 150.0, 8.0, 0.0),
